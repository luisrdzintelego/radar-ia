...
// Create a player.
var videos = {
  "url_1": "../videos/mod1_vid1.mp4",
  "url_2": "../videos/mod1_vid2.mp4",
  "url_3": "../videos/mod1_vid3.mp4",
  "url_4": "../videos/mod1_vid4.mp4",
}
...
var vtts1 = {
  "url_1": "../videos/esp_mod1_vid1.vtt",
  "url_2": "../videos/esp_mod1_vid2.vtt",
  "url_3": "../videos/esp_mod1_vid3.vtt",
  "url_4": "../videos/esp_mod1_vid4.vtt",
}

var vtts2 = {
  "url_1": "../videos/ing_mod1_vid1.vtt",
  "url_2": "../videos/ing_mod1_vid2.vtt",
  "url_3": "../videos/ing_mod1_vid3.vtt",
  "url_4": "../videos/ing_mod1_vid4.vtt",
}

var vtts3 = {
  "url_1": "../videos/por_mod1_vid1.vtt",
  "url_2": "../videos/por_mod1_vid2.vtt",
  "url_3": "../videos/por_mod1_vid3.vtt",
  "url_4": "../videos/por_mod1_vid4.vtt",
}
  ...
  for (i = 1; i <= cant_videos; i++) {
    ...
    (function (i) {
      ...
      var videoOptions = {
        ...
        num: i,
        tracks: [
        { src: vtts1[`url_${i}`], kind: 'subtitles', srclang: 'es', label: 'Spanish', mode: '' },
        { src: vtts2[`url_${i}`], kind: 'subtitles', srclang: 'en', label: 'English', mode: '' },
        { src: vtts3[`url_${i}`], kind: 'subtitles', srclang: 'pt', label: 'Portuguese', mode: 'showing' },
        ]
      }
      ...
      player.on('click', function(evt) { 
        if (wp.debugMode) console.log("🚀 ~ evt:", evt.target.tagName)
        if (evt.target.tagName === 'VIDEO' ||evt.target.tagName === 'SPAN' ) {
          if (wp.debugMode) console.log('video was clicked'); 

          //PAUSA TODOS LOS VIDEOS EXCEPTO EL QUE ESTAR DANDO CLIC
          for (z = 1; z <= cant_videos; z++) {
            //if (wp.debugMode) console.log("🚀 ~ videoOptions.num != z:", z , videoOptions.num != z)
            if(videoOptions.num != z){
              $(`#my-video${z} video`).get(0).pause();
            } 
          }
        }
      });
